...
<div class="container" style=" padding: 8%; padding-top: 2%; margin: 10%; border:2px solid #12a8bb;">
	<h2 style="text-align: center; margin-bottom: 10%;">Form Peminjaman </h2>
		<div class="col-md-12">
        ...
        <button type="submit" class="btn btn-primary" style="margin-top: 5%; padding: 2% 15%; border-radius: 20px;">Pinjam</button>
        <button type="submit" class="btn btn-primary" style="margin-top: 5%; padding: 2% 15%; border-radius: 20px;">Pinjam</button>
        <div class="col-md-12 col-sm-12">
            <div class="table-responsive" style="margin-top: 2%;">
              <table class="table table-striped">
            ...
            <button type="submit" class="btn btn-primary" style="margin-top: 5%; padding: 2% 15%; border-radius: 20px;">Konfirmasi</button>
          </div>
				<br><br>
